...
//creating new user
const tokenQuery = "SELECT * FROM register WHERE id = $1";
const newUserQuery =
  "INSERT INTO register ( email,password, first_name,last_name,gender,job_role,department,address) VALUES ($1,$2,$3,$4,$5,$6,$7,$8) RETURNING *";
